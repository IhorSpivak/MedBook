package ua.profarma.medbook.ui.today;
...
import ua.profarma.medbook.recyclerviews.tasks.TasksRecyclerView;
import ua.profarma.medbook.recyclerviews.visits.VisitRecyclerItem;
import ua.profarma.medbook.recyclerviews.visits.VisitsDashboardRecyclerView;
...
import ua.profarma.medbook.ui.NotificationsActivity;
...
import ua.profarma.medbook.ui.custom_views.NonSwipeableViewPager;
import ua.profarma.medbook.ui.materials.MaterialsEnum;
import ua.profarma.medbook.ui.points.PointsActivity;
import ua.profarma.medbook.ui.profile.ProfileActivity;
import ua.profarma.medbook.ui.today.tabs.CustomTab;
import ua.profarma.medbook.ui.today.tabs.TodayPagerAdapter;
...
public class TodayFragment extends MedBookFragment {
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable final Bundle savedInstanceState) {
        ...
        viewTab1 = (CustomTab) LayoutInflater.from(getContext()).inflate(R.layout.custom_tab_today, null, true);
        viewTab2 = (CustomTab) LayoutInflater.from(getContext()).inflate(R.layout.custom_tab_today, null, true);
