...
import ua.profarma.medbook.events.core.ConcurrentArrayList;
import ua.profarma.medbook.events.core.Event;
import ua.profarma.medbook.events.core.EventRouter;
import ua.profarma.medbook.events.materials.EventTestResultLoad;
        ...
        switch (event.getEventId()) {
            case Event.EVENT_USER_NOTIFICATION_REACTION:
                ...
                if(minRecationNotification < minRecationNotificationTest){
                    DialogBuilder.showInfoDialogInterface(this,
                            ...
                            String.format(Core.get().LocalizationControl().getText(R.id.need_push_reaction),
                                    String.valueOf(minRecationNotificationTest - minRecationNotification)));
                }
                break;
