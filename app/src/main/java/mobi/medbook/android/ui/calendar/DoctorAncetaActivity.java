...
import mobi.medbook.android.recyclerviews.visit_doctor_question.VisitDoctorQuestionRecyclerItem;
import mobi.medbook.android.recyclerviews.visit_doctor_question.VisitDoctorQuestionsRecyclerView;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnSend.setOnClickListener(view -> {
            if (Core.get().VisitsControl().isStartSendDoctorAnceta()) {
                ...
                Toast.makeText(this, "Зустріч завершено" , Toast.LENGTH_SHORT).show();
                finish();
            } else
                DialogBuilder.showInfoDialog(this, "Повідомлення", "Заповніть всі дані");
